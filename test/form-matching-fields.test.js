...
describe('FormMatchingFieldsElement', () => {
	...
	beforeEach(() => {
		element = document.createElement('form-matching-fields');
	...
	it('should be defined', () => {
		expect(customElements.get('form-matching-fields')).toBe(FormMatchingFieldsElement);
	});

	it('should create an instance', () => {
		expect(element).toBeInstanceOf(FormMatchingFieldsElement);
	...
	describe('Shadow DOM Best Practices', () => {
		it('should create shadow root in constructor', () => {
			const newElement = new FormMatchingFieldsElement();
	...
	describe('Attributes and Properties', () => {
		...
		it('should handle lazy property upgrade (property set before element upgrade)', () => {
			...
			const uninitializedElement =
				document.createElement('form-matching-fields');
